/*WAP by creating a class name employee with four data members)ID,name,position and salary). Using member functions
 initialize the data members for the 3 objects and display information of all three of them .Assume appropriate
 data types.*/
#include<iostream>
using namespace std;
class employee{
